const VARIANTS = {
  ...
  Blocked:         'bg-red-600/10 text-red-400 border-red-600/20',
  Closed:          'bg-slate-500/10 text-slate-400 border-slate-500/20',
  Completed:       'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  Current:         'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  Scheduled:       'bg-blue-500/10 text-blue-400 border-blue-500/20',
  Upcoming:        'bg-blue-500/10 text-blue-400 border-blue-500/20',
  'Due Soon':      'bg-yellow-500/10 text-yellow-400 border-yellow-500/20',
  ...
  'Needs POA&M':   'bg-orange-500/10 text-orange-400 border-orange-500/20',
  ...
  // Operational categories / sources
  Manual:               'bg-slate-500/10 text-slate-400 border-slate-500/20',
  ConMon:               'bg-cyan-500/10 text-cyan-400 border-cyan-500/20',
  Tracker:              'bg-violet-500/10 text-violet-400 border-violet-500/20',
  Backups:              'bg-blue-500/10 text-blue-400 border-blue-500/20',
  Training:             'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  'Account Management': 'bg-cyan-500/10 text-cyan-400 border-cyan-500/20',
  'Vulnerability Management': 'bg-orange-500/10 text-orange-400 border-orange-500/20',
  'Log Review':         'bg-indigo-500/10 text-indigo-400 border-indigo-500/20',
  'Incident Readiness': 'bg-red-500/10 text-red-400 border-red-500/20',
  'Configuration Management': 'bg-yellow-500/10 text-yellow-400 border-yellow-500/20',
  'Physical Security':  'bg-slate-500/10 text-slate-400 border-slate-500/20',
  'Contingency Planning': 'bg-blue-500/10 text-blue-400 border-blue-500/20',
  // Classification
